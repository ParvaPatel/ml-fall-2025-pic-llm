...
\begin{itemize}[leftmargin=*]
    ...
    \begin{itemize}[leftmargin=1.5em,label=\textbf{--}]
        \item GPT-oss: average loss $11.05$, throughput $11.94$ tokens/s, elapsed $1.26$ s.
        \item Benchmarks are gated behind \texttt{--collect\_transformer\_metrics}; the number above matches the \texttt{RECORDED\_TRANSFORMER\_BENCHMARK} entry in \texttt{pico-llm.py}.
    \end{itemize}
\end{itemize}
